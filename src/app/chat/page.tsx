        ...
        <div className="flex items-center gap-3 border-b border-navy-100 pb-4 dark:border-navy-800">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Ask any question regarding BIS standards, ISI Mark requirements, QCO gazettes, and test specifications.
            </p>
          </div>
        </div>
        ...
        <div className="flex min-h-[450px] items-center justify-center rounded-2xl border border-dashed border-navy-200 bg-white p-12 text-center dark:border-navy-800 dark:bg-navy-950">
          <div className="max-w-md">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Foundation initialized. The split-panel interface with real-time SSE streaming, citation badges, and confidence indicators will connect in subsequent phases.
            </p>
          </div>
        </div>
      </div>
